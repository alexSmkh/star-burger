...
Для обновления проекта на проде используйте скрипт `deploy.sh`. Он подтянет изменения из репозитория, обновит
зависимости, сбилдит фрот и статику, перезапустит сервер.
